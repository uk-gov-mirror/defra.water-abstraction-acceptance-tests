@basic @readonly @bs
Feature: [WATER - <JIRA no.>] Basic login
  ...
  Scenario: [WATER - <JIRA no.> - AC1] Incorrect password prompts reentering sign in details
    Given I am on the sign in page
    When I enter my password incorrectly
    Then I am informed "Your email address or password is incorrect"

  Scenario: [WATER - <JIRA no.> - AC2] Request password reset
    Given I am on the sign in page
    When I request a password reset
    Then I am on the Check Your Email page

  Scenario: [WATER - <JIRA no.> - AC3] Valid login
    Given I am on the sign in page
